...
function Dashboard() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/orders/${editForm._id}`, {
        method: "PUT",
        headers: {
            ...
            <form onSubmit={handleUpdate} className="space-y-4 p-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-800 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  required
                />
              </div>
